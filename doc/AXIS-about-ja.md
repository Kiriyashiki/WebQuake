...
WebQuakeをAXISに接続することで、緊急地震速報を受信することができます。
...
- WebQuakeでの実装も同様に実験的なものです。問題があればご報告ください
...
これで、WebQuake設定の「AXIS Token • トークン」の下にそれを貼り付けて、緊急地震速報を有効にすることができます。
...
*AXISとは最大2つの同時接続が可能なので、WebQuakeと別のアプリ（KEVIなど）を同時に利用することができます。*
